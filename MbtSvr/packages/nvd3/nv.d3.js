// TO Customizations made 10/15/2014
(function(){
...
// TO Customization 1 line
            if (false){//chartContainer) {
  ...
  nv.tooltip.calcTooltipPosition = function(pos, gravity, dist, container) {
            ...
            var height = parseInt(container.offsetHeight),
                ...
                left, top;
//TO Customization 3 lines
            if (scrollTop == 0) {
                scrollTop = d3.select("#Dashboad .container-fluid").property("scrollTop");
            }
            ...
            switch (gravity) {
              ...
              case 'w':
                ...
                //if (tTop + height > scrollTop + windowHeight) top = scrollTop + windowHeight - tTop + top - height;
// TO Customization 1 line
                if (tTop + height > scrollTop + windowHeight) top =  top - height + 5;
                break;
              case 'n':
...
// TO Customization 5 lines
  chart.legendKey = function(_) {
