/* replaced space in coords with comma , TestOptimal.com, 2/10/2010 
 * added modeNormal check and change options.xx */
...
(function($) {
	...
	var areaCoords = area.getAttribute('coords').replace(/ /g,",");
	...
	$.fn.maphilight = function(opts) {
		...
		return this.each(function() {
			...
			mouseover = function(e) {
				if (modeNormal) { // Testoptimal code
					var shape = shape_from_area(this);
					options = setGraphHilightOptions(options);
